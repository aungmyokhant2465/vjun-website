    ...
    return (
        ...
        <section>
            ...
            <p>
                ...
                groundbreaking  innovations, by making our products more sustainably, by building a creative and diverse team and by making a positive impact in communities where we live and work.
            </p>
        </section>
        <article class="about-slides">
            <section>
                <div data-aos="fade-right">
                    <h3>V.Jun</h3>
                    <p>Wireless charging is not something of the future, it’s everywhere, so your experience should be hassle-free. Our iPhone cases are built to withstand Qi, supporting the new standard of wireless charging. Charge away without having to remove your iPhone cases, so you never have to compromise style for functionality.</p>
                </div>
                <div class="about-img-container" data-aos="flip-left">
                    <img src={img2} alt="" />
                </div>
            </section>
            <section>
                <div class="about-img-container" data-aos="flip-right">
                    <img src={img3} alt="" />
                </div>
